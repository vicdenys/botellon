<div id="footerContainer" class="   left-0 w-screen lg:border-t  {{ $isDarkTheme ? 'border-t-green lg:border-t-white' : 'border-t-green lg:bg-white' }} {{ isset($isAboutNav)  ? 'absolute  -bottom-[calc(var(--vh,1vh)*100)] overflow-hidden z-[64]' : 'fixed bottom-0 z-[60]'  }}">
