...
<nav id="navigation" class=" block    w-screen border-b  {{ $isDarkTheme || $isAboutNav ? 'border-b-white ' : 'border-b-green bg-white' }} {{ $isAboutNav  ? 'border-b-green bg-white sticky top-0 z-[64]' : 'fixed top-0 z-[60]'  }}">
