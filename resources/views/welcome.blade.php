    ...
    <div id="homeTopHero" class=" snap-start snap-always">
        <div class=" max-h-screen  relative z-40 mx-auto items-center text-[1.5rem] ">
            <div id="homePageWrapper" class="w-full h-screen flex justify-center">
                ...
                <div id="homePageSubTitleWrapper" class=" absolute  w-full overflow-hidden bottom-[4.8rem] bottom-[calc(4.8rem+env(safe-area-inset-bottom))] lg:bottom-20 lg:bottom-[calc(5rem+env(safe-area-inset-bottom))] md:h-28 h-20 mx-auto md:py-8 border-t border-t-white text-center font-victorianna-thin text-white text-2xl sm:text-4xl lg:text-6xl">
