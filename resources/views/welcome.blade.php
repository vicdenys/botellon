    ...
    <div class=" snap-center snap-always">
        <div class=" max-h-screen  relative z-40 mx-auto items-center text-[1.5rem] ">
            <div id="homePageWrapper" class="w-full h-screen flex justify-center">
                ...
                <div id="homePageSubTitleWrapper" class=" absolute bottom-20 w-full overflow-hidden  md:h-28 h-20 mx-auto md:py-8 border-t border-t-white text-center font-victorianna-thin text-white text-2xl sm:text-4xl lg:text-6xl">
