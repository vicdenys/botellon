...
return [
    ...
    "1.2" => "Vanop ons terras kijkt u uit op de vernieuwde gedempte zuiderdokken en het nieuw aangelegde Zuidpark.",
    "1.3" => "Achter onze hoek bent u meteen aan de vernieuwde Scheldekaaien ter hoogte van De Gerlachekaai.",
    "1.4" => "Het fotomuseum (FOMU) en de stadsbioscoop Lumière liggen vlak naast de deur, het museum voor hedendaagse kunst (MUHKA) ligt op 200m afstand en het museum van Schone Kunsten (KMSKA) ligt op 5 minuten wandelafstand.",
    ...
    "2.3" => "do-vrij",
    "2.4" => "geopend vanaf 15u",
    "3.1" => "zat-zon",
    "3.2" => "geopend vanaf 10u30",
];
